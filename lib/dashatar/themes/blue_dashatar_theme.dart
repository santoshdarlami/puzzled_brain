...
class BlueDashatarTheme extends DashatarTheme {
  ...
  Color get backgroundColor => PuzzleColors.primaryBackground;
  ...
  Color get buttonColor => Colors.black54;

  @override
  // Color get menuInactiveColor => PuzzleColors.blue50;
  Color get menuInactiveColor => Colors.black54;

  @override
  // Color get countdownColor => PuzzleColors.blue50;
  Color get countdownColor => Colors.black87;
