...
abstract class PuzzleColors {
  ...
  static const Color primary1 = Color(0xFF555555);
  static const Color primaryGreen = Color(0xFF60A446);
  static const Color primaryYellow = Color(0xFFC5B100);
  static const Color primaryBackground = Color(0xFFFFFFFF);
  static const Color textColor = Color(0xFF888888);
  // static const Color primaryTextColor = Color(0xFFF0F0F0);
  static const Color primaryTextColor = Color(0xFF10200C);
